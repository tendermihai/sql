...
SELECT model FROM masini WHERE color='Red';
-- selecteaza modelul din tabelul masini unde culoarea este rosie

SELECT * FROM masini;
--selecteaza toate datele din tabelul masini

SELECT make FROM masini WHERE color != 'Red';
--selecteaza make din tabelul masini unde culoarea e diferita de Red

SELECT model FROM masini WHERE id < 11;
-- selecteaza model din tabelul masini, unde id este mai mic de 11

SELECT * FROM masini WHERE make='Toyota' AND color='Blue';
--selectaza toate masinile Toyota care au culoarea blue din tabelul masini

SELECT make FROM masini WHERE id IN(10,30);
--selecteaza make din tabelul masini care au id-ul 10 si 30

SELECT * FROM masini WHERE color NOT IN('Red');
-- selecteaza datele din tabelul masini  a caror culoarea nu este Red

SELECT * FROM masini WHERE make LIKE 'Acura';
-- selecteaza datele din tabelul masina unde coloana make contine numele Acura

SELECT model FROM masini WHERE id BETWEEN 10 AND 25;
--selecteaza modelul masinilor cu id-ul cuprins intre 10 si 25.

SELECT * FROM masini WHERE make LIKE '%ota';
--selecteaza datele din tabelul masini unde coloana make contine caracterele 'ota'.

SELECT * FROM masini WHERE color IS NULL;
--selecteaza datele din tabelul masini unde coloana color este null

SELECT * FROM masini WHERE make IS NOT NULL;
--selecteaza datele din tabelul masini unde coloana make nu este null.